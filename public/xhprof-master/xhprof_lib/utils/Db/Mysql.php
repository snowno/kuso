...
class Db_Mysql extends Db_Abstract
{
    ...
    {
//        var_dump($this->config['dbhost']);exit;
        $this->linkID = mysqli_connect($this->config['dbhost'], $this->config['dbuser'], $this->config['dbpass']);
        ...
        mysqli_select_db($this->config['dbname'], $this->linkID);
    }
    
    public function query($sql)
    {
        var_dump($sql);
        return mysqli_query($sql, $this->linkID);
    }
    ...
    {
        return mysqli_real_escape_string($str, $this->linkID);
    }
